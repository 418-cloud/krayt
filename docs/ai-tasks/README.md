...
| [`add-proxy-ssrf-guard.md`](./add-proxy-ssrf-guard.md) | Low | Refuse proxy targets that resolve to link-local/metadata (always) or private ranges (unless `full`). | ⬜ Open |
